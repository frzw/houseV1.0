...
<@common.header/>
<style>
    /*.property .overlay { -moz-transition: 0.4s; transition: 0.4s;bottom: -50px; left: 0; position: relative; width: 100%; z-index: 1; }*/
</style>
...
<div class="wrapper">
            ...
            <div class="slide">
                <div class="container">
                    <div class="overlay">
                        ...
                        <hr>
                        <a href="property-detail.html" class="link-arrow">阅读更多...</a>
                    </div>
                </div>
    ...
    <div id="page-content">
        ...
        <section id="testimonials" class="block">
            <div class="container">
                <header class="section-title"><h2>知名经纪人</h2></header>
